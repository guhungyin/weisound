...
<style>
    .contactBanner{
        background: url('../assets/images/company/contact/bg-support.webp') no-repeat center center / cover;
    }
    .breadcrumb-box{
    ...
    .card-body h3{
        color: #373f50;
        font-weight: bold;}
    .card-body a{color: #4b566b;}
    .card-body a:hover{color: #4C74B9;}
    .card-body ul{font-size: 0.875rem;}
